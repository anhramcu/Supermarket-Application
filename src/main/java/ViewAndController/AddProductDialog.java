...
public class AddProductDialog extends javax.swing.JDialog {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(checkEmpty()){
            ...
            p.setDescribe(txtProductDescribe.getText());
            p.setAmount(Integer.parseInt(txtProductAmount.getText()));
            p.setPrice(Float.parseFloat(txtProductPrice.getText()));
                    
            System.out.println("add new Product = " + ProductDAO.getInstance().addProduct(p));
        }else
         System.out.println("Fill all DataInput !!!");
    ...
    private boolean checkEmpty() {
        return !(txtProductName.getText().isEmpty() || txtProductDescribe.getText().isEmpty()
                || txtProductAmount.getText().isEmpty() || txtProductPrice.getText().isEmpty());
    }
