...
//        
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        Product p2 = new Product(p.getId(), txtProductName.getText(), txtProductDescribe.getText(), Integer.parseInt(txtProductAmount.getText()), Float.parseFloat(txtProductPrice.getText()));
        System.out.println("edit :" + ProductDAO.getInstance().editProduct(p2));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        ProductDAO.getInstance().deleteProductById(p);
        this.dispose();
